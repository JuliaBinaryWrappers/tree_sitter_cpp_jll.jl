...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import tree_sitter_cpp_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("db96dd59-cc3e-5205-9518-9f32d21f88e9"))
platforms = [Pkg.Artifacts.unpack_platform(e, "tree_sitter_cpp", artifacts_toml) for e in artifacts["tree_sitter_cpp"]]
...
if best_platform === nothing
    @debug("Unable to load tree_sitter_cpp; unsupported platform $(triplet(platform_key_abi()))")
else
...
end  # module tree_sitter_cpp_jll
